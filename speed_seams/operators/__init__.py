...
from .op_grease_pencil import HighlightUnifiedEdges
...
classes = (SPEEDSEAMS_OT_Apply_Transforms, SPEEDSEAMS_OT_ApplyLocation, SPEEDSEAMS_OT_ApplyRotation, SPEEDSEAMS_OT_ApplyScale, SPEEDSEAMS_OT_AutoSmooth, SPEEDSEAMS_OT_ClearSeams,
           SPEEDSEAMS_OT_ClearSharpEdges, SPEEDSEAMS_OT_MarkSharpAsSeams, SPEEDSEAMS_OT_UnwrapSelected, SPEEDSEAMS_OT_SharpenSlider, SPEEDSEAMS_OT_drawOverlay, SPEEDSEAMS_OT_removeOverlay, HighlightUnifiedEdges)
